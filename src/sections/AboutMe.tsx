  ...
  <Container>
    ...
    >
      ...
      <Flex flexDir="column" gap={5} color="white">
        ...
        <Paragraph>
          I’m a creative developer with a passion for good design and intuitive,
          user friendly interfaces. I love working on the front end, whether
          that’s creating a beautiful and performant mobile apps or using React
          and TypeScript to create interactive and responsive web apps.
        </Paragraph>
        ...
        <Paragraph>
          Creating and developing applications that are not only beautiful, but
          pleasant to use and really problem-solving.
        </Paragraph>
        ...
        <Paragraph>
          Helping companies build complex Web and Mobile applications that serve
          users around the world with React and modern technologies.
        </Paragraph>
      </Flex>
    </Flex>
    ...
    >
      ...
      >
        <ListItem>
          <ExternalLink title="Github" href="https://github.com/iamdevmarcos" />
        </ListItem>
